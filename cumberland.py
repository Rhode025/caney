...
DATA={"depth":DEPTH,"depthRef":"Depth rise measured at the Burkesville gauge (USGS 03414100, 100k paired points). Upstream ramps show the jet read off the release — no stage gauge exists there, so no depth is claimed.",
      ...
      "points":[{"name":k,"lat":v[0],"lon":v[1],"types":ACC_TYPES.get(k,[]),"info":ACC_INFO.get(k,""),"twra":riverlib.twra_for(v[0],v[1],"cumberland river")} for k,v in {"Wolf Creek Dam":[36.86729,-85.14693],"Kendall Rec Area":[36.87013,-85.13305],"Helm's Landing":[36.89801,-85.14509],"Rockhouse":[36.88566,-85.23342],"Winfrey's Ferry":[36.87641,-85.24747],"Burkesville City Ramp":[36.78612,-85.36578]}.items()],
...
riverlib.emit_status("cumberland",
    ...
    wx, [o["grade"] for o in outlook] or riverlib.GRADE_SCORE.get(_t["grade"],2.0), CT, ["Trout"], "Trophy trout tailwater", "~2.5 hr · destination (KY)", days=DAYS)
