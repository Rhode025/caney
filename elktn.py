...
def _gauge_day(off):
    ...
    if off != 0:
        return riverlib.day_state(vessel="boat", vessel_why="tailwater float",
    ...
    if not vals:
        return riverlib.day_state(vessel="boat", vessel_why="tailwater float", headline="No gauge reading today")
    ...
    _vk, _vlabel, _vw, _conf = riverlib.craft_label("elktn", med)
...
riverlib.emit_status("elktn",
    ...
    wx, _TB.get(FG,1.6), CT, ["Trout"], "Trout tailwater", "~90 min · SE of Nashville", days=DAYS)
