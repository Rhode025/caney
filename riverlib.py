...
RIVERS = [
    ...
    {"id": "harpeth",    "name": "Harpeth River", "emoji": "🪶", "file": "harpeth.html",
     "on_bg": "#eef0f7", "on_fg": "#4a5590", "species": "Smallmouth"},
 ...
 {"id":"cheatham","name":"Cumberland \u00b7 Cheatham","emoji":"\U0001f309","file":"cheatham.html","on_bg":"#eef1f6","on_fg":"#3a5a8c","species":"Striped bass & smallmouth"},
 {"id":"cordell","name":"Cumberland \u00b7 Cordell Hull","emoji":"\U0001f309","file":"cordell.html","on_bg":"#eef1f6","on_fg":"#3a5a8c","species":"Smallmouth & white bass"},
]
...
RIVER_CONFIG = {
 ...
 "cheatham": {
   "name": "Cumberland \u00b7 Cheatham","sub": "Cheatham Dam toward Clarksville \u2014 the lower Middle TN reach","species": "Striped bass, smallmouth & panfish",
   "vessel": "power-drifter / jon boat","base": "Cheatham Dam tailwater","lat": 36.42,"lon": -87.3,
   "model":"warmwater big-river, generation-driven current",
   "gauge": {"type": "cwms", "site": "ASHT1-CHEATHAM", "label": "Cheatham release (USACE LRN)"},
   "bands":[["Slack / no gen","under ~7,000 cfs","Old Hickory idle — little current; work the ledges, wing dams & structure slow & deep"],
            ["Generating","~7,000–30,000","current on — stripers & smallmouth feed; swing streamers through the tailrace"],
            ["High / heavy","over ~30,000","strong, stained flow — fish eddies, creek mouths & slack behind the wing dams"]],
   ...
   "flies":[["Baitfish streamer (Clouser / Deceiver)","the striper & white-bass standard — swing & strip it through the tailrace when they generate"],
            ...
            ["Crawfish / Woolly Bugger","bottom fly along the rock ledges & wing dams for smallmouth"],
            ["Popper / bream bug","topwater smallmouth & panfish in the slack water & backwaters"]],
   "regs": "Tennessee license. Cheatham reservoir: striped & hybrid bass 15 in. minimum, 2/day combined; black bass per TWRA statewide. Verify current TWRA Region 2 regs.",
 },
 "cordell": {
   "name": "Cumberland \u00b7 Cordell Hull","sub": "Cordell Hull Dam at Carthage into Old Hickory Lake","species": "Smallmouth, white bass & panfish",
   "vessel": "jon boat / power-drifter","base": "Cordell Hull Dam tailwater","lat": 36.28,"lon": -85.95,
   "model":"warmwater big-river, generation-driven current",
   "gauge": {"type": "cwms", "site": "COHT1-CORDELL_HULL", "label": "Cordell Hull release (USACE LRN)"},
   "bands":[["Slack / no gen","under ~7,000 cfs","Old Hickory idle — little current; work the ledges, wing dams & structure slow & deep"],
            ["Generating","~7,000–30,000","current on — stripers & smallmouth feed; swing streamers through the tailrace"],
            ["High / heavy","over ~30,000","strong, stained flow — fish eddies, creek mouths & slack behind the wing dams"]],
   ...
   "flies":[["Baitfish streamer (Clouser / Deceiver)","the striper & white-bass standard — swing & strip it through the tailrace when they generate"],
            ...
            ["Crawfish / Woolly Bugger","bottom fly along the rock ledges & wing dams for smallmouth"],
            ["Popper / bream bug","topwater smallmouth & panfish in the slack water & backwaters"]],
   "regs": "Tennessee license. Black bass and white bass per TWRA statewide limits. Verify current TWRA Region 2 regs.",
 },
 "stones": {
...
RIVER_CONFIG["harpeth"] = _derive("duck", name="Harpeth River",
    sub="Hwy 100 to the Cumberland confluence — Tennessee State Scenic River",
    species="Smallmouth", vessel="canoe / kayak",
    gauge={"type": "usgs", "site": "03434500", "label": "Harpeth near Kingston Springs (USGS 03434500)"},
    lat=36.12, lon=-87.05,
    launch={"name": "Narrows of the Harpeth or Hidden Lake",
            "desc": "Harpeth River State Park units. The Narrows loop is the classic float; the upper units above Kingston Springs run skinnier."},
    hazards=["No dam anywhere on the Harpeth — nothing buffers a rain event, and the low gradient means it drops slowly.",
             "Strainers, logjams and deadfall on the bends, worst after high water.",
             "The Narrows tunnel is a historic structure, not a boat route — portage the neck.",
             "Wear a PFD, scout blind bends, and check the gauge the morning you go."])
